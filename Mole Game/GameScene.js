...
class GameScene extends Phaser.Scene {
    constructor() {
        ...
        // lists all of the burrow locations
    ...
    initializeBurrowKeys() {
        ...
        gameState.jKey = this.input.keyboard.addKey('a');
        gameState.kKey = this.input.keyboard.addKey('s');
        gameState.lKey = this.input.keyboard.addKey('d');
        gameState.iKey = this.input.keyboard.addKey('w');
